...
namespace Trackr {
    public partial class TeacherEditAccount : Form {
        public string newUsername;
        public string newPassword;
        public TeacherEditAccount(string existingUsername) {
            InitializeComponent();
        ...
        private void TeacherEditAccount_Paint(object sender, PaintEventArgs e) {
        ...
        async private void submitChangedClick(object sender, EventArgs e) { 
            ...
            if (usernameCheckBox.Checked) {
                if (username == "") {
                    ...
                    bool usernameTaken = await APIHandler.IsUsernameTaken(UserType.Teacher, username);
                    if (usernameTaken) {
